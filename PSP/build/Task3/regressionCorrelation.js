...
exports.getRegressionCorrelation = (xList, yList, E) => {
    if (xList.getSize() !== yList.getSize()) {
        throw Error('xList and yList should be of same dimension');
    }
    const listSize = xList.getSize();
    const meanX = twoWayBindedList_1.TwoWayList.average(xList);
    const meanY = twoWayBindedList_1.TwoWayList.average(yList);
    let result = {
        b0: 0,
        b1: 0,
        r: 0,
...
//# sourceMappingURL=regressionCorrelation.js.map